...
**Summary:** The project involved developing a credit risk default model on Indian companies using the performance data of several companies to predict whether a company is going to default on upcoming loan payments.
...
1. Jupyter Notebook
2. Business Presentation (including figures created using Tableau)
3. Dataset
